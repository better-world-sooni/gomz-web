...
const SplashDraft = ({iPhoneWidth, isTablet, showTime}) => {
	...
	return (
		<Draft draft={draft1} onMouseEnter={isTablet ? ()=>setHover1Mobile(true):()=>sethover1(true)} onMouseLeave={!isTablet&&(()=>sethover1(false))} iPhoneWidth={iPhoneWidth} content={
			<Div absolute wFull hFull bgWhite flex flexCol itemsCenter justifyCenter>
				...
				<motion.div animate={draft1.hover.display3.animate} transition={draft1.hover.display3.transition} style={{position:"relative"}}><Div maxH={10} maxH15={!isTablet} imgTag src={IMAGES.appDrafts.draft1.bwWord}/></motion.div>
			</Div>
		}/>
	)
}
...
export function Draft({draft=null, onMouseEnter=null, onMouseLeave=null, onClick=null, content=null, iPhoneWidth}) {
	return (
		<Div onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave} onClick={onClick} cursorPointer>
