        ...
        <Div flex itemsCenter hFull mxAuto z10 relative>
          <Div flex itemsCenter>
            ...
            <Div relative flexCol>
              ...
              <Div px={kaikas?.selectedAddress ? 130 : 150} relative mt20 w700>
                {kaikas?.selectedAddress ? (
                  <Div textWhite fontSize={"1.5vw"} textCenter itemsCenter>
                    <Title mintingStep={mintingStep} whitelisted={whitelisted} totalSupply={totalSupply} amountMinted={amountMinted} balance={balance} />
                  </Div>
                ) : (
              ...
              <EmptyBlock h={20} />
              {kaikas?.selectedAddress ? (
                <CallToAction mintingStep={mintingStep} whitelisted={whitelisted} totalSupply={totalSupply} amountMinted={amountMinted} balance={balance} />
              ) : (
                <Div flex justifyCenter>
                  <MotionButtonTimer>
                    <Div
